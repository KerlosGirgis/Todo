        ...
        : Scaffold(
            ...
            body: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: MediaQuery.of(context).orientation==Orientation.portrait?2:4,childAspectRatio: 0.7),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(
                                  ...
                                  notes[index].title,
                                  style: TextStyle(color: colorProvider.taskTitle, fontSize: 20),
                                ),
                              ),
                            ),
                          );
                      ...
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          pageBuilder: (context,
                              animation,
                              secondaryAnimation) =>
                           NoteEditorPage(colorProvider: colorProvider, note: notes[index],),
                          transitionsBuilder: (context,
                              animation,
                              secondaryAnimation,
                              child) {
