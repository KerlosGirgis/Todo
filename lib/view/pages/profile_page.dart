    ...
    return Consumer<UserProvider>(
      builder: (context, user, child) {
        return Scaffold(
            ...
            backgroundColor: user.colorProvider.pageBackground,
            body: MediaQuery.of(context).orientation == Orientation.portrait||MediaQuery.sizeOf(context).aspectRatio<1.5
                ? SingleChildScrollView(
                    scrollDirection: Axis.vertical,
                    child: Column(
                      spacing: MediaQuery.sizeOf(context).height/32,
                      children: [
                        AspectRatio(
                          aspectRatio: 2,
                          child: Row(
                              ...
                              Stack(
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    bottom: MediaQuery.sizeOf(context).width / 30,
                                    child: SizedBox(
                                      width: MediaQuery.sizeOf(context).width / 10,
                                      height: MediaQuery.sizeOf(context).width / 10,
                                      child: FloatingActionButton(
                                        backgroundColor: user.colorProvider.editPicButtonBackground,
                                        elevation: 3,
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: GestureDetector(
                                                      child: CircleAvatar(
                                                        backgroundImage:
                                                        AssetImage(IconProvider.getAvatar("000")),
                                                      ...
                                                      onTap: () {
                                                        showDialog(
                                                          context: context,
                                                          builder: (context) => AvatarsListDialog(),
                                                        ).then((_) {
                                                          if (context.mounted) {
                                                            Navigator.pop(context);
                                                          }
                                        ...
                                        child: Icon(Icons.edit, color: Colors.blue,size: MediaQuery.sizeOf(context).width/15,),
                                      ),
                                    ),
                                  ),
                                ],
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        padding: EdgeInsets.only(right: MediaQuery.sizeOf(context).width/75,left: MediaQuery.sizeOf(context).width/75),
                                        child: Row(
                                          spacing: MediaQuery.sizeOf(context).width/50,
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Expanded(
                                    ...
                                    children: [
                                      CircleAvatar(
                                        backgroundImage: user.user.pic.startsWith("0")
                                            ? AssetImage(IconProvider.getAvatar(user.user.pic))
                                            : FileImage(File(user.user.pic)) as ImageProvider,
                                        radius: MediaQuery.sizeOf(context).height / 4,
                                        backgroundColor: Colors.transparent,
                                      ),
                                      Positioned(
                                        right: MediaQuery.sizeOf(context).width / 50, // Adjust dynamically
                                        bottom: MediaQuery.sizeOf(context).height / 50,
                                        child: SizedBox(
                                          width: MediaQuery.sizeOf(context).height / 10,  // Proportional size
                                          ...
                                          child: FloatingActionButton(
                                                      ...
                                                      Expanded(
                                                        child: GestureDetector(
                                                          child: CircleAvatar(
                                                            backgroundImage:
                                                            AssetImage(IconProvider.getAvatar("000")),
                                                            radius: MediaQuery.sizeOf(context).height / 7,
                                                            backgroundColor: Colors.transparent,
                                                          ),
                                                          onTap: () {
                                                            showDialog(
                                            ...
                                            child: Icon(
                                              Icons.edit,
                                              color: Colors.blue,
                                              size: MediaQuery.sizeOf(context).height / 20, // Dynamic icon size
                                            ),
                                          ),
                                        ),
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: SizedBox(
                                          width: MediaQuery.sizeOf(context).width / 4, // Slightly larger in landscape
                                          child: AutoSizeText(
                                            user.user.name,
                                            minFontSize: 25,  // Reduced slightly for landscape
                                            maxLines: 1,
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                              overflow: TextOverflow.ellipsis,
                                              fontWeight: FontWeight.bold,
                                              fontSize: 35, // Adjusted for landscape
                                ...
                                child: PageView(
                                  ...
                                  children: [
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                      ...
                                      Expanded(
                                        child: Row(
                                          spacing: MediaQuery.sizeOf(context).width/80,
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Expanded(
                                              child: SettingsButton(
